...
resource "aws_ec2_transit_gateway_peering_attachment" "tgw_us-west-2_peering_attachment" {
...
resource "aws_ec2_transit_gateway_route_table_association" "peering_association" {
  transit_gateway_attachment_id  = aws_ec2_transit_gateway_peering_attachment.tgw_us-west-2_peering_attachment.id
  transit_gateway_route_table_id = aws_ec2_transit_gateway_route_table.tgw_us-west-2_route_table.id
